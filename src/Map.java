public class Map {
  ...
  static class Room {
    ...
    int       info;
    int[][]   moves;  // {move, location, condition}
    ...
    //	If carrying object
    //		114		1	14	Giant clam
    //		115		1	15	Giant oyster
    //    150		1 50	Large gold nugget
    //		159		1 59	Egg-sized emerald
    //
    //	If carrying object or at object's location ??
    //		211		2	11	Snake
    //    233		2	33	Troll
    //
    //	If object's status != (value / 100) - 3
    //    303		3	 3	Grate unlocked
    //		309		3	 9	Rusty door oiled
    //		311		3	11	Snake not present
    //    312		3	12	Fissure has crystal bridge
    //		331		3	31	Dragon is not present
    //    332		3	32	Chasm bridge wrecked
    //    412		4	12	Fissure's crystal bridge has vanished
    //		524		5	24	Plant has not been watered
    //    724		7	24	Plant has been plant has been watered twice

    //  Location Codes:
    //    < 300           Move to Room
    //    > 300 & < 500   Special Move, such as plover or crossing troll bridge
    //    > 500           Print special response = code - 500
  ...
  static final Room[] cave = {
    new Room("You are standing at the end of a road before a small brick building.  " +      // Room 1
      ...
      new int[][] {
        ...
        {  3,   3,   0},        // enter to loc 3 (inside building)
        { 12,   3,   0},        // building, house to loc 3 (inside building)
        { 19,   3,   0},        // in, inside, inward to loc 3 (inside building)
        { 43,   3,   0},        // E to loc 3 (inside building)
        {  5,   4,   0},        // ?? not in vocabbulary
        { 13,   4,   0},        // gully to loc 4 (valley)
        { 14,   4,   0},        // stream to loc 4 (valley)
        { 46,   4,   0},        // S to loc 4 (valley)
        { 30,   4,   0},        // Dn to loc 4 (valley)
        {  6,   5,   0},        // forest to loc 5 (forest)
        { 45,   5,   0},        // N to loc 5 (forest)
        { 43,   5,   0},        // E to loc 5 (forest)
        { 63,   8,   0}}),      // depression to loc 8 (outside grate)
    new Room("You have walked up a hill, still in the forest.  The road slopes back " +      // Room 2
      "down the other side of the hill.  There is a building in the distance.",
      "You're at hill in road.",
      Adventure.LIGHT,
      new int[][] {
        {  2,   1,   0},        // hill, road to loc 1 (end of road again)
        { 12,   1,   0},        // building, house to loc 1 (end of road again)
        {  7,   1,   0},        // forward, onward to loc 1 (end of road again)
    ...
    new Room("You are inside a building, a well house for a large spring.",                  // Room 3
      "You're inside building.",
        Adventure.LIGHT + Adventure.LIQUID,
      new int[][] {
        {  3,   1,   0},        // enter to loc 1 (end of road again)
        { 11,   1,   0},        // exit, leave, out, outside to loc 1 (end of road again)
        { 32,   1,   0},        // outdoors to loc 1 (end of road again)
        { 44,   1,   0},        // W to loc 1 (end of road again)
        { 62,  11,   0},        // xyzzy to loc 11 (debris room)
        { 65,  33,   0},        // plugh to loc 33 ('Y2')
 //       { 78, 140,   0},        // qqq to Dead end (with vending machine) (for debugging)
        {  5,  79,   0},        // ?? not in vocabbulary
        { 14,  79,   0}}),      // stream to loc 14 (top of small pit)
    new Room("You are in a valley in the forest beside a stream tumbling along a " +         // Room 4
      "rocky bed.",
      "You're in valley.",
        Adventure.LIGHT + Adventure.LIQUID,
      new int[][] {
        {  4,   1,   0},        // downstream, upstream loc 1 (end of road again)
        { 12,   1,   0},        // building, house loc 1 (end of road again)
        { 45,   1,   0},        // N to loc 1 (end of road again)
        {  6,   5,   0},        // forest to loc 5 (forest)
        { 43,   5,   0},        // E to loc 5 (forest)
        { 44,   5,   0},        // W to loc 5 (forest)
        { 29,   5,   0},        // Up to loc 5 (forest)
        {  5,   7,   0},        // ?? not in vocabbulary
    ...
    new Room("You are in open forest, with a deep valley to one side.",                      // Room 5
      ...
      new int[][] {
        ...
        { 30,   4,   0},        // Dn to loc 4 (valley)
        {  6,   5,  50},        // forest to loc 5 (forest) (50% chance(
        {  7,   5,  50},        // forward, onward to loc 5 (forest) (50% chance(
        { 45,   5,  50},        // N to loc 5 (forest) (50% chance(
        {  6,   6,   0},        // forest lt loc 6 (forest)
        { 44,   5,   0},        // W to loc 5 (forest)
        { 46,   5,   0}}),      // S to loc 5 (forest)
    ...
    new Room("At your feet all the water of the stream splashes into a 2-inch slit " +       // Room 7
      ...
      new int[][] {
        { 12,   1,   0},        // building, house to loc 1 (end of road again)
        {  4,   4,   0},        // downstream, upstream to loc 4 (valley)
        { 45,   4,   0},        // N to loc 4 (valley)
        {  6,   5,   0},        // forest to loc 5 (forest)
        { 43,   5,   0},        // E to loc 5 (forest)
        { 44,   5,   0},        // W to loc 5 (forest)
        {  5,   8,   0},        // ?? not in vocabbulary
        { 15,   8,   0},        // rock to loc 8 (outside grate)
        { 16,   8,   0},        // bed to loc 8 (outside grate)
        { 46,   8,   0},        // S to loc 8 (outside grate)
        { 60, 595,   0},        // slit print "You don't fit through a two-inch slit!"
        { 14, 595,   0},        // stream print "You don't fit through a two-inch slit!"
        { 30, 595,   0}}),      // Dn print "You don't fit through a two-inch slit!"
    new Room("You are in a 20-foot depression floored with bare dirt.  Set into the " +      // Room 8
      ...
      new int[][] {
        ...
        {  4,   7,   0},        // downstream, upstream to loc 7 (slit in streambed)
        { 13,   7,   0},        // gully to loc 7 (slit in streambed)
        { 45,   7,   0},        // N to loc 7 (slit in streambed)
        {  3,   9, 303},        // enter to loc 9 (below the grate) (if grate unlocked)
        { 19,   9, 303},        // in, inside, inward to loc 9 (below the grate) (if grate unlocked)
        { 30,   9, 303},        // Dn to loc 9 (below the grate) (if grate unlocked)
        {  3, 593,   0}}),      // enter print "You can't go through a locked steel grate!"
    new Room("You are in a small chamber beneath a 3x3 steel grate to the surface.  " +      // Room 9
      "A low crawl over cobbles leads inward to the West.",
      "You're below the grate.",
        Adventure.LIGHT,
      new int[][] {
        { 11,   8, 303},        // exit, leave, out, outside to loc 8 (outside grate) (if grate unlocked)
        { 29,   8, 303},        // Up to loc 8 (outside grate) (if grate unlocked)
        { 11, 593,   0},        // exit, leave, out, outside print "You can't go through a locked steel grate!"
        { 17,  10,   0},        // crawl to loc 10 (cobble crawl)
        { 18,  10,   0},        // cobblestone to loc 10 (cobble crawl)
        { 19,  10,   0},        // in, inside, inward to loc 10 (cobble crawl)
        { 44,  10,   0},        // W to loc 10 (cobble crawl)
        { 31,  14,   0},        // pit to loc 14 (top of small pit)
        { 51,  11,   0}}),      // debris to loc 11 (debris room)
    new Room("You are crawling over cobbles in a low passage.  There is a dim light " +      // Room 10
      "at the east end of the passage.",
      "You're in cobble crawl.",
        Adventure.LIGHT,
      new int[][] {
        { 11,   9,   0},        // exit, leave, out, outside to loc 9 (below the grate)
        { 20,   9,   0},        // surface to loc 9 (below the grate)
        { 21,   9,   0},        // nowhere, null to loc 9 (below the grate)
        { 43,   9,   0},        // E to loc 9 (below the grate)
        { 19,  11,   0},        // in, inside, inward to loc 11 (debris room)
        { 22,  11,   0},        // dark to loc 11 (debris room)
    ...
    new Room("You are in a debris room filled with stuff washed in from the " +              // Room 11
      ...
      "You're in debris room.",
        0,
      new int[][] {
        { 63,   8, 303},        // depression to loc 8 (outside grate) (if grate unlocked)
        { 64,   9,   0},        // entrance to loc 9 (below the grate)
        { 17,  10,   0},        // crawl to loc 10 (cobble crawl)
        { 18,  10,   0},        // cobblestone to loc 10 (cobble crawl)
        { 23,  10,   0},        // passage, tunnel to loc 10 (cobble crawl)
        { 24,  10,   0},        // low to loc 10 (cobble crawl)
        { 43,  10,   0},        // E to loc 10 (cobble crawl)
        { 25,  12,   0},        // canyon to loc 12 (awkward sloping east/west canyon)
        { 19,  12,   0},        // in, inside, inward to loc 12 (awkward sloping east/west canyon)
        { 29,  12,   0},        // Up to loc 12 (awkward sloping east/west canyon)
        { 44,  12,   0},        // W to loc 12 (awkward sloping east/west canyon)
        { 62,   3,   0},        // xyzzy to,loc 3 (inside building)
        { 31,  14,   0}}),      // pit to loc 14 (top of small pit)
    new Room("You are in an awkward sloping east/west canyon.",                              // Room 12
      ...
      new int[][] {
        ...
        { 51,  11,   0},        // debris to loc 11 (debris room)
        { 19,  13,   0},        // in, inside, inward to loc 13 (bird chamber)
    ...
    new Room("You are in a splendid chamber thirty feet high.  The walls are frozen " +      // Room 13
      ...
      new int[][] {
        ...
        { 23,  14,   0},        // passage, tunnel to loc 14 (top of small pit)
        { 31,  14,   0},        // pit to loc 14 (top of small pit)
    ...
    new Room("At your feet is a small pit breathing traces of white mist. An east " +        // Room 14
      ...
      new int[][] {
        ...
        { 64,   9,   0},        // entrance to loc 9 (below the grate)
        { 51,  11,   0},        // debris to loc 11 (debris room)
        { 23,  13,   0},        // passage, tunnel to loc 13 (bird chamber)
        { 43,  13,   0},        // E to loc 13 (bird chamber)
        { 30,  20, 150},        // Dn to loc 20 (bottom of the pit with a broken neck) (if carrying Large gold nugget)
        { 31,  20, 150},        // pit to loc 20 (bottom of the pit with a broken neck) (if carrying Large gold nugget)
        { 34,  20, 150},        // steps to loc 20 (bottom of the pit with a broken neck) (if carrying Large gold nugget)
        { 30,  15,   0},        // Dn to loc 15 (hall of mists)
        { 33,  16,   0},        // crack to loc 16 (The crack is far too small for you to follow)
    ...
    new Room("You are at one end of a vast hall stretching forward out of sight to " +       // Room 15
      ...
      "You're in hall of mists.",
        0,
      new int[][] {
        { 36,  18,   0},        // left to loc 18 (nugget of gold room)
        { 46,  18,   0},        // S to loc 18 (nugget of gold room)
        {  7,  17,   0},        // forward, onward to loc 17 (on east bank of fissure)
        { 38,  17,   0},        // hall to loc 17 (on east bank of fissure)
        { 44,  17,   0},        // W to loc 17 (on east bank of fissure)
        { 10,  19,   0},        // stairs to loc 19 (hall of mt)
        { 30,  19,   0},        // Dn to loc 19 (hall of mt)
        { 45,  19,   0},        // N to loc 19 (hall of mt)
        { 29,  22, 150},        // Up to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 31,  22, 150},        // pit to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 34,  22, 150},        // steps to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 35,  22, 150},        // dome to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 23,  22, 150},        // passage, tunnel to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 43,  22, 150},        // E to loc 22 (The dome is unclimbable) (if carrying Large gold nugget)
        { 29,  14,   0},        // Up to loc 14 (top of small pit)
        { 55,  34,   0}}),      // y2 to loc 34 (jumble of rock, with cracks everywhere)
    new Room("The crack is far too small for you to follow.",                                // Room 16
      "The crack is far too small for you to follow.",
      Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  14,   0}}),        // Forced move to loc 14 ()
    new Room("You are on the east bank of a fissure slicing clear across the hall.  " +      // Room 17
      "The mist is quite thick here, and the fissure is too wide to jump.",
      "You're on east bank of fissure.",
        0,
      new int[][] {
        { 38,  15,   0},        // hall to loc 15 (hall of mists)
        { 43,  15,   0},        // E to loc 15 (hall of mists)
        { 39, 596, 312},        // jump print "I respectfully suggest you go across the bridge instead of jumping" (if Fissure has crystal bridge)
        {  7,  21, 412},        // forward, onward to loc 21 (dead) (if Fissure's crystal bridge has vanished)
        { 41, 597, 412},        // over print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 42, 597, 412},        // across print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 44, 597, 412},        // W print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 69, 597, 412},        // cross print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 41,  27,   0}}),      // over to loc 27 ()
    new Room("This is a low room with a crude note on the wall.  The note says: " +         // Room 18
      ...
      new int[][] {
        { 38,  15,   0},        // hall to loc 15 (hall of mists)
        { 11,  15,   0},        // exit, leave, out, outside to loc 15 (hall of mists)
    ...
    new Room("You are in the hall of the mountain king, with passages off in all " +         // Room 19
      ...
      "You're in hall of mt. king.",
        0,
      new int[][] {
        { 10,  15,   0},        // stairs to loc 15 (hall of mists)
        { 29,  15,   0},        // Up to loc 15 (hall of mists)
        { 43,  15,   0},        // E to loc 15 (hall of mists)
        { 45,  28, 311},        // N to loc 28 (low N/S passage at a hole in the floor) (if Snake not present)
        { 46,  29, 311},        // S to loc 29 (south side chamber) (if Snake not present)
        { 37,  29, 311},        // right to loc 29 (south side chamber) (if Snake not present)
        { 44,  30, 311},        // W to loc 30 (west side chamber of the hall of the mountain king) (if Snake not present)
        {  7,  30, 311},        // forward, onward to loc 30 (west side chamber of the hall of the mountain king) (if Snake not present)
        { 45,  32,   0},        // N to loc 32 (You can't get by the snake)
        { 49,  74,  35},        // SW to loc 74 (secret E/W canyon above tight canyon) (35% chance)
        { 49,  32, 211},        // SW to loc 32 (You can't get by the snake) (Snake present)
        { 66,  74,   0}}),      // secret to loc 74 (secret E/W canyon above tight canyon)
    new Room("You are at the bottom of the pit with a broken neck.",                         // Room 20
      "You are at the bottom of the pit with a broken neck.",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,   0,   0}}),      // Forced move to loc 0 (death)
    ...
    new Room("The dome is unclimbable.",                                                     // Room 22
      "The dome is unclimbable.",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  15,   0}}),      // Forced move to loc 15 (hall of mists)
    new Room("You are at the west end of the twopit room.  There is a large hole in " +      // Room 23
      ...
      new int[][] {
        ...
        { 42,  67,   0},        // across to loc 67 (east end of twopit room)
        { 44,  68,   0},        // W to loc 68 (slab room)
        { 61,  68,   0},        // slab to loc 68 (slab room)
        { 30,  25,   0},        // Dn to loc 25 (west pit)
        { 31,  25,   0},        // pit to loc 25 (west pit)
        { 52, 648,   0}}),      // hole print "It is too far up for you to reach"
    new Room("You are that the bottom of the eastern pit in the twopit room.  There " +      // Room 24
      ...
      new int[][] {
        ...
        { 11,  67,   0}}),      // exit, leave, out, outside to loc 67 (east end of twopit room)
    new Room("You are at the bottom of the western pit in the towpit room. There is " +      // Room 25
      ...
      new int[][] {
        ...
        { 11,  23,   0},        // exit, leave, out, outside to loc 23 (west end of twopit room)
        { 56,  31, 724},        // climb to loc 31 (>$<) (if plant has been watered twice)
        { 56,  26,   0}}),      // climb to loc 26 (west pit)
    new Room("You clamber up the plant and scurry through the hole at the top.",             // Room 26
      "You clamber up the plant and scurry through the hole at the top.",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  88,   0}}),      //  Forced move to loc 88 (narrow corridor)
    new Room("You are on the west side of the fissure in the hall of mists.",                // Room 27
      "You are on the west side of the fissure in the hall of mists.",
        0,
      new int[][] {
        { 39, 596, 312},        // jump print "I respectfully suggest you go across the bridge instead of jumping" (if Fissure has crystal bridge)
        {  7,  21, 412},        // forward, onward to loc 21 (death)  (if Fissure's crystal bridge has vanished)
        { 41, 597, 412},        // over print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 42, 597, 412},        // across print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 43, 597, 412},        // E print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 69, 597, 412},        // cross print "There is no way across the fissure" (if Fissure's crystal bridge has vanished)
        { 41,  17,   0},        // over to loc 17 (east bank of fissure)
    ...
    new Room("You are in a low N/S passage at a hole in the floor.  The hole goes " +        // Room 28
      ...
      "You are in a low N/S passage at a hole in the floor.  The hole goes " +
        ...
        0,
      new int[][] {
        { 38,  19,   0},        // hall to loc 19 (hall of mt)
        { 11,  19,   0},        // exit, leave, out, outside to loc 19 (hall of mt)
        { 46,  19,   0},        // S to loc 19 (hall of mt)
        { 45,  33,   0},        // N to loc 33 ('Y2')
        { 55,  33,   0},        // y2 to loc 33 ('Y2')
        { 30,  36,   0},        // Dn to loc 36 (dirty passage)
        { 52,  36,   0}}),      // hole to loc 36 (dirty passage)
    ...
    new Room(">$<",                                                                          // Room 31
      ">$<",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  89, 524},        // Forced move to loc 89 (nothing here to climb) (if Plant has has not been watered)
        {  1,  90,   0}}),      // Forced move to loc 90 ()
    new Room("You can't get by the snake.",                                                  // Room 32
      "You can't get by the snake.",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  19,   0}}),      // Forced move to loc 19 (hall of mt. king)
    new Room("You are in a large room, with a passage to the south, a passage to " +         // Room 33
      ...
      "You're at 'Y2'.",
        0,
      new int[][] {
        { 65,   3,   0},        // plugh to loc 3 (inside building)
    ...
    new Room("You are in a dirty broken passage.  To the east is a crawl.  To the " +        // Room 36
      ...
      new int[][] {
        ...
        { 17,  37,   0},        // crawl to loc 37 (brink of a small clean climbable pit)
        { 29,  28,   0},        // Up to loc 28 (low N/S passage at a hole in the floor)
        { 52,  28,   0},        // hole to loc 28 (low N/S passage at a hole in the floor)
        { 44,  39,   0},        // W to loc 39 (dusty rock room)
        { 70,  65,   0}}),      // bedquilt to loc 65 (You are in bedquilt)
    new Room("You are on the brink of a small clean climbable pit.  A crawl leads " +        // Room 37
      ...
      new int[][] {
        ...
        { 17,  36,   0},        // crawl to loc 36 (dirty passage)
        { 30,  38,   0},        // Dn to loc 38 (bottom of a small pit with a little stream)
        { 31,  38,   0},        // pit to loc 38 (bottom of a small pit with a little stream)
        { 56,  38,   0}}),      // climb to loc 38 (bottom of a small pit with a little stream)
    new Room("You are in the bottom of a small pit with a little stream, which " +           // Room 38
      ...
      "You are in the bottom of a small pit with a little stream, which " +
        ...
        Adventure.LIQUID,
      new int[][] {
        { 56,  37,   0},        // climb to loc 37 (brink of a small clean climbable pit)
        { 29,  37,   0},        // Up to loc 37 (brink of a small clean climbable pit)
        { 11,  37,   0},        // exit, leave, out, outside to loc 37 (brink of a small clean climbable pit)
        { 60, 595,   0},        // slit print "You don't fit through a two-inch slit!"
        { 14, 595,   0},        // stream print "You don't fit through a two-inch slit!"
        { 30, 595,   0},        // Dn print "You don't fit through a two-inch slit!"
        {  4, 595,   0},        // downstream, upstream print "You don't fit through a two-inch slit!"
        {  5, 595,   0}}),      // ?? not in vocabbulary
    new Room("You are in a large room full of dusty rocks.  There is a big hole in " +       // Room 39
      ...
      new int[][] {
        ...
        { 23,  36,   0},        // passage, tunnel to loc 36 (dirty passage)
        { 30,  64,   0},        // Dn to loc 64 (complex junction)
        { 52,  64,   0},        // hole to loc 64 (complex junction)
        { 58,  64,   0},        // floor to loc 64 (complex junction)
        { 70,  65,   0}}),      // bedquilt to loc 65 (You are in bedquilt)
    new Room("You have crawled through a very low wide passage parallel to and " +           // Room 40
      ...
      "You have crawled through a very low wide passage parallel to and " +
        ...
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  41,   0}}),      // Forced move to loc 41 (west end of hall of mists)
    new Room("You are at the west end of hall of mists.  A low wide crawl continues " +      // Room 41
      ...
      new int[][] {
        ...
        { 23,  42,   0},        // passage, tunnel to loc 42 (maze of twisty little passages)
        { 56,  42,   0},        // climb to loc 42 (maze of twisty little passages)
        ...
        { 17,  60,   0}}),      // crawl to loc 60 (east end of long hall)
    ...
    new Room("Dead end",                                                                     // Room 46
      ...
      new int[][] {
        ...
        { 11,  45,   0}}),      // exit, leave, out, outside to loc 45 (maze of twisty little passages)
    ...
    new Room("Dead end",                                                                     // Room 48
      ...
      new int[][] {
        ...
        { 11,  44,   0}}),      // exit, leave, out, outside to loc 44 (maze of twisty little passages)
    ...
    new Room("Dead end",                                                                     // Room 54
      ...
      new int[][] {
        ...
        { 11,  53,   0}}),      // exit, leave, out, outside to loc 53 (maze of twisty little passages)
    ...
    new Room("Dead end",                                                                     // Room 56
      ...
      new int[][] {
        ...
        { 11,  55,   0}}),      // exit, leave, out, outside to loc 55 (maze of twisty little passages)
    new Room("You are on the brink of a thirty foot pit with a massive orange " +            // Room 57
      ...
      new int[][] {
        ...
        { 56,  13,   0},        // climb to loc 13 (bird chamber)
    ...
    new Room("Dead end",                                                                     // Room 58
      ...
      new int[][] {
        { 43,  57,   0},        // E to loc 57 (brink of pit)
        { 11,  57,   0}}),      // exit, leave, out, outside to loc 57 (brink of pit)
    new Room("You have crawled through a very low wide passage paralled to and " +           // Room 59
      ...
      Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  27,   0}}),      // Forced move to loc 27 (west side of the fissure in the hall of mists)
    new Room("You are at the east end of a very long hall apparently without side " +        // Room 60
      ...
      new int[][] {
        ...
        { 29,  41,   0},        // Up to loc 41 (west end of hall of mists)
        { 17,  41,   0},        // crawl to loc 41 (west end of hall of mists)
        ...
        { 52,  62,   0}}),      // hole to loc 62 (crossover of a high N/S passage and a low E/W one)
    ...
    new Room("Dead end",                                                                     // Room 63
      ...
      new int[][] {
        ...
        { 11,  62,   0}}),      // exit, leave, out, outside to loc 62 (crossover of a high N/S passage and a low E/W one)
    new Room("You are at a complex junction.  A low hands and knees passage from " +         // Room 64
      ...
      new int[][] {
        ...
        { 56,  39,   0},        // climb to loc 39 (dusty rock room)
        { 59,  39,   0},        // room to loc 39 (dusty rock room)
        { 44,  65,   0},        // W to loc 65 (You are in bedquilt)
        { 70,  65,   0},        // bedquilt to loc 65 (You are in bedquilt)
        { 45, 103,   0},        // N to loc 103 (shell room)
        { 74, 103,   0},        // shell to loc 103 (shell room)
    ...
    new Room("You are in bedquilt, a long east/west passage with holes everywhere.  " +      // Room 65
      ...
      new int[][] {
        ...
        { 46, 556,  80},        // S print "You have crawled around in some little holes and wound up back in the main passage."
        { 61,  68,   0},        // slab to loc 68 ()
        { 29, 556,  80},        // Up print "You have crawled around in some little holes and wound up back in the main passage."
        { 29,  70,  50},        // Up to loc 70 (secret N/S canyon above a sizable passage) (50% chance(
        { 29,  39,   0},        // Up to loc 39 (dusty rock room)
        { 45, 556,  60},        // N  print "You have crawled around in some little holes and wound up back in the main passage." (60% chance(
        { 45,  72,  75},        // N to loc 72 (large low room) (75% chance(
        { 45,  71,   0},        // N to loc 71 (junction of three secret canyons)
        { 30, 556,  80},        // Dn print "You have crawled around in some little holes and wound up back in the main passage." (80% chance(
    ...
    new Room("You are in a room whose walls resemble swiss cheese.   Obvious " +             // Room 66
      ...
      new int[][] {
        ...
        { 46, 556,  80},        // S print "You have crawled around in some little holes and wound up back in the main passage." (80% chance(
        { 25,  77,   0},        // canyon to loc 77 ()
        { 43,  96,   0},        // E to loc 96 (soft room)
        { 50, 556,  50},        // NW print "You have crawled around in some little holes and wound up back in the main passage." (50% chance(
        { 72,  97,   0}}),      // oriental to loc 97 (oriental room)
    new Room("You are at the east end of the twopit room.  The floor here is " +             // Room 67
      ...
      new int[][] {
        ...
        { 42,  23,   0},        // acrossto loc 23 (west end of twopit room)
        { 30,  24,   0},        // Dn to loc 24 (east pit)
        { 31,  24,   0}}),      // pit to loc 24 (east pit)
    new Room("You are in a large low circular chamber whose floor is an immense " +          // Room 68
      ...
      new int[][] {
        ...
        { 56,  69,   0},        // climb to loc 69 (secret N/S canyon above a large room)
    ...
    new Room("You are in a secret N/S canyon above a large room.",                           // Room 69
      ...
      new int[][] {
        ...
        { 61,  68,   0},        // slab to loc 68 (slab room)
        { 46, 120, 331},        // S to loc 120 (secret canyon which exits to the north and east) (if Dragon is not present)
    ...
    new Room("You are in a secret N/S canyon above a sizable passage.",                      // Room 70
      ...
      new int[][] {
        ...
        { 23,  65,   0},        // passage, tunnel to loc 65 (You are in bedquilt)
    ...
    new Room("Dead end crawl.",                                                              // Room 73
      ...
      new int[][] {
        ...
        { 17,  72,   0},        // crawl to loc 72 (large low room)
        { 11,  72,   0}}),      // exit, leave, out, outside to loc 72 (large low room)
    ...
    new Room("The stream flows out through a pair of 1 foot diameter sewer pipes.  " +       // Room 79
      ...
      Adventure.FORCED_MOVE,
      new int[][] {
        {  1,   3,   0}}),      // Forced move to loc 3 (inside building)
    ...
    new Room("You are in a long, narrow corridor stretching out of sight to the " +          // Room 88
      ...
      new int[][] {
        { 30,  25,   0},        // Dn to loc 25 (west pit)
        { 56,  25,   0},        // climb to loc 25 (west pit)
        { 43,  25,   0},        // E to loc 25 (west pit)
        { 39,  20,   0},        // jump
        { 44,  92,   0},        // W to loc 92 (giant room)
        { 27,  92,   0}}),      // giant to loc 92 (giant room)
    new Room("There is nothing here to climb.  Use 'up' or 'out' to leave the pit.",         // Room 89
      ...
      Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  25,   0}}),      // Forced move to loc 25 (west pit)
    new Room("You have climbed up the plant and out of the pit.",                            // Room 90
      "You have climbed up the plant and out of the pit.",
        Adventure.FORCED_MOVE,
      new int[][] {
        {  1,  23,   0}}),      // Forced move to loc 23 (twopit room)
    new Room("You are at the top of a steep incline above a large room. You could " +        // Room 91
      ...
      new int[][] {
        ...
        { 73,  95,   0},        // cavern to loc 95 (cavern with waterfall)
        { 23,  95,   0},        // passage, tunnel to loc 95 (cavern with waterfall)
        { 30,  72,   0},        // Dn to loc 72 (large low room)
        { 56,  72,   0}}),      // climb to loc 72 (large low room)
    ...
    new Room("The passage here is blocked by a recent cave-in.",                             // Room 93
      ...
      new int[][] {
        ...
        { 27,  92,   0},        // giant to loc 92 (giant room)
        { 11,  92,   0}}),      // exit, leave, out, outside to loc 92 (giant room)
    new Room("You are at one end of an immense north/south passage.",                        // Room 94
      ...
      new int[][] {
        { 46,  92,   0},        // S to loc 92 (giant room)
        { 27,  92,   0},        // giant to loc 92 (giant room)
        { 23,  92,   0},        // passage, tunnel to loc 92 (giant room)
        { 45,  95, 309},        // N to loc 95 (cavern with waterfall) (if Rusty door oiled)
        {  3,  95, 309},        // enter to loc 95 (cavern with waterfall) (if Rusty door oiled)
        { 73,  95, 309},        // cavern to loc 95 (cavern with waterfall) (if Rusty door oiled)
        { 45, 611,   0}}),      // N print "The door is extremely rusty and refuses to open"
    new Room("You are in a magnificent cavern with a rushing stream, which cascades " +      // Room 95
      ...
      new int[][] {
        ...
        { 11,  94,   0},        // exit, leave, out, outside to loc 94 (immense north/south passage)
        { 27,  92,   0},        // giant to loc 92 (giant room)
    ...
    new Room("You are in the soft room.  The walls are covered with heavy curtains, " +      // Room 96
      ...
      new int[][] {
        { 44,  66,   0},        // W to loc 66 (swiss cheese room)
        { 11,  66,   0}}),      // exit, leave, out, outside to loc 66 (swiss cheese room)
    new Room("This is the oriental room.  Ancient oriental cave drawings cover the " +       // Room 97
      ...
      new int[][] {
        ...
        { 73,  98,   0}}),      // cavern to loc 98 (misty cavern)
    ...
    new Room("You're in the dark-room.  A corridor leading south is the only exit.",         // Room 101
      ...
      new int[][] {
        ...
        { 71, 100,   0},        // plover to loc 100 (plover room)
        { 11, 100,   0}}),      // exit, leave, out, outside to loc 100 (plover room)
    new Room("You are in an arched hall.  A coral passage once continued up and " +          // Room 102
      ...
      new int[][] {
        ...
        { 74, 103,   0},        // shell to loc 103 (shell room)
        { 11, 103,   0}}),      // exit, leave, out, outside
    new Room("You're in a large room carved out of sedimentary rock. The floor and " +       // Room 103
      ...
      new int[][] {
        ...
        { 38, 102,   0},        // hall to loc 102 (arched hall)
        { 30, 104,   0},        // Dn to loc 104 (long sloping corridor with ragged sharp walls)
        { 46, 618, 114},        // S print "You can't fit this five-foot clam through that little passage!" (if carrying clam)
        { 46, 619, 115},        // S print "You can't fit this five foot oyster through that little passage!" (if carrying oyster)
    ...
    new Room("You are in a maze of twisty little passages, all different.",                  // Room 107
      ...
      new int[][] {
        ...
        { 45, 139,   0},        // N to loc 139 (maze of little twisty passages)
    ...
    new Room("You are at Witt's end.  Passages lead off in ALL directions.",                 // Room 108
      "You're at Witt's end.",
        0,
      new int[][] {
        { 43, 556,  95},        // E to loc 556 (95% chance)
        { 45, 556,  95},        // N to loc 556 (95% chance)
        { 46, 556,  95},        // S to loc 556 (95% chance)
        { 47, 556,  95},        // NE to loc 556 (95% chance)
        { 48, 556,  95},        // SE to loc 556 (95% chance)
        { 49, 556,  95},        // SW to loc 556 (95% chance)
        { 50, 556,  95},        // NW to loc 556 (95% chance)
        { 29, 556,  95},        // Up to loc 556 (95% chance)
        { 30, 556,  95},        // Dn to loc 556 (95% chance)
        { 43, 106,   0},        // E to loc 106 (anteroom)
    ...
    new Room("A large stalactite extends from the roof and almost reaches the floor " +      // Room 111
      ...
      new int[][] {
        ...
        { 30,  50,  40},        // Dn to loc 50 (maze of twisty little passages) (40% chance)
        { 39,  50,  40},        // jump to loc 50 (maze of twisty little passages) (40% chance)
        { 56,  50,  40},        // climb to loc 50 (maze of twisty little passages) (40% chance)
        { 30,  53,  50},        // Dn to loc 53 (maze of twisty little passages) (50% chance)
        { 30,  45,   0}}),      // Dn to loc 45 (maze of twisty little passages)
    new Room("You are in a little maze of twisting passages, all different.",                // Room 112
      ...
      new int[][] {
        ...
        { 29, 139,   0},        // Up to loc 139 (maze of little twisty passages)
        { 46, 140,   0}}),      // S to loc 140 (Dead end)
    new Room("You are at the edge of a large underground reservoir.  An opaque " +           // Room 113
      ...
      new int[][] {
        ...
        { 11, 109,   0},        // exit, leave, out, outside to loc 109 (mirror canyon)
        {109, 109,   0}}),      //
    ...
    new Room("You are at the southwest end of the repository.  To one side is a pit " +      // Room 116
      ...
      new int[][] {
        ...
        { 30, 593,   0}}),      // Dn print "You can't go through a locked steel grate!"
    new Room("You are on one side of a large deep chasm.  A heavy white mist rising " +      // Room 117
      ...
      new int[][] {
        { 49, 118,   0},        // SW to loc 118 (sloping corridor)
        { 41, 660, 233},        // over print "The troll refuses to let you cross." (if Troll present)
        { 42, 660, 233},        // across print "The troll refuses to let you cross." (if Troll present)
        { 69, 660, 233},        // cross print "The troll refuses to let you cross." (if Troll present)
        { 47, 660, 233},        // NE print "The troll refuses to let you cross." (if Troll present)
        { 41, 661, 332},        // over print "There is no longer any way across the chasm" (if Chasm bridge wrecked)
        { 41, 303,   0},        // over special move 303
        { 39,  21, 332},        // jump to loc 21 (if Chasm bridge wrecked)
        { 39, 596,   0}}),      // jump print "I respectfully suggest you go across the bridge instead of jumping"
    ...
    new Room("You are in a secret canyon which exits to the north and east.",                // Room 119
      ...
      new int[][] {
        ...
        { 11,  69,   0},        // exit, leave, out, outsideto loc 69 (secret N/S canyon above a large room)
        { 43, 653,   0},        // E print "The dragon looks rather nasty.  You'd best not try to get by."
        {307,  65,   0}}),      //
    ...
    new Room("You are in a secret canyon which exits to the north and east.",                // Room 121
      ...
      new int[][] {
        { 43,  74,   0},        // E to loc 74 (secret E/W canyon above tight canyon)
        { 11,  74,   0},        // exit, leave, out, outside to loc 74 (secret E/W canyon above tight canyon)
        { 45, 653,   0},        // N print "The dragon looks rather nasty.  You'd best not try to get by."
        {  7, 653,   0}}),      // forward, onward print "The dragon looks rather nasty.  You'd best not try to get by."
    new Room("You are on the far side of the chasm.  A ne path leads away from the " +       // Room 122
      ...
      new int[][] {
        ...
        { 42, 660, 233},        // across print "The troll refuses to let you cross." (if Troll present)
        { 69, 660, 233},        // cross print "The troll refuses to let you cross." (if Troll present)
        { 49, 660, 233},        // SW print "The troll refuses to let you cross." (if Troll present)
        { 41, 303,   0},        // over special move 303
        { 39, 596,   0},        // jump print "I respectfully suggest you go across the bridge instead of jumping"
        { 77, 124,   0},        // fork to loc 124 (fork in path)
        { 28, 126,   0},        // view to loc 126  (breath-taking view)
        { 40, 129,   0}}),      // barren to loc 129 (front of barren room)
    ...
    new Room("The path forks here.  The left fork leads northeast.  A dull rumbling " +      // Room 124
      ...
      new int[][] {
        ...
        { 36, 125,   0},        // left loc 125 (junction with warm walls)
        { 48, 128,   0},        // SE to loc 128 (limestone passage)
        { 37, 128,   0},        // right to loc 128 (limestone passage)
    ...
    new Room("The walls are quite warm here.  From the north can be heard a steady " +       // Room 125
      ...
      new int[][] {
        ...
        { 17, 127,   0}}),      // crawl  to loc 127 (chamber of boulders)
    new Room("You are on the edge of a breath-taking view.  Far below you is an " +          // Room 126
      ...
      new int[][] {
        ...
        { 23, 125,   0},        // passage, tunnel to loc 125 (junction with warm walls)
        { 11, 125,   0},        // exit, leave, out, outside to loc 125 (junction with warm walls)
        { 77, 124,   0},        // fork to loc 124 (fork in path)
        { 30, 610,   0},        // Dn print "Don't be ridiculous!"
        { 39, 610,   0}}),      // jump print "Don't be ridiculous!"
    new Room("You are in a small chamber filled with large boulders. The walls are " +       // Room 127
      ...
      new int[][] {
        ...
        { 11, 125,   0},        // exit, leave, out, outside to loc 125  (junction with warm walls)
        { 17, 125,   0},        // crawl to loc 125  (junction with warm walls)
        { 77, 124,   0},        // fork to loc 124 (fork in path)
        { 28, 126,   0}}),      // view to loc 126  (breath-taking view)
    ...
    new Room("You are standing at the entrance to a large, barren room.  A sign " +          // Room 129
      ...
      new int[][] {
        ...
        { 19, 130,   0},        // in, inside, inward to loc 130 (barren room)
        { 40, 130,   0},        // barren to loc 130 (barren room)
        {  3, 130,   0},        // enter to loc 130 (barren room)
        { 28, 126,   0}}),      // view to loc 126 (breath-taking view)
    ...
    new Room("You are in a maze of twisting little passages, all different.",                // Room 131
      ...
      new int[][] {
        ...
        { 46, 139,   0},        // S to loc 139  (maze of little twisty passages)
    ...
    new Room("You are in a little maze of twisty passages, all different.",                  // Room 132
      ...
      new int[][] {
        ...
        { 30, 139,   0},        // Dn to loc 139 (maze of little twisty passages)
    ...
    new Room("You are in a twisting maze of little passages, all different.",                // Room 133
      ...
      new int[][] {
        ...
        { 48, 139,   0},        // SE to loc 139 (maze of little twisty passages)
    ...
    new Room("You are in a twisting little maze of passages, all different.",                // Room 134
      ...
      new int[][] {
        ...
        { 44, 139,   0},        // W to loc 139 (maze of little twisty passages)
    ...
    new Room("You are in a twisty little maze of passages, all different.",                  // Room 135
      ...
      new int[][] {
        ...
        { 50, 139,   0},        // NW to loc 139  (maze of little twisty passages)
    ...
    new Room("You are in a twisty maze of little passages, all different.",                  // Room 136
      ...
      new int[][] {
        ...
        { 47, 139,   0},        // NE to loc 139 (maze of little twisty passages)
    ...
    new Room("You are in a little twisty maze of passages, all different.",                  // Room 137
      ...
      new int[][] {
        ...
        { 43, 139,   0},        // E to loc 139 (maze of little twisty passages)
    ...
    new Room("You are in a maze of little twisting passages, all different.",                // Room 138
      ...
      new int[][] {
        ...
        { 49, 139,   0},        // SW to loc 139 (maze of little twisty passages)
 ...
 //       { 78,   3,   0},        // qqq to Well house
        { 11, 112,   0}}),      // exit, leave, out, outside
  };
}
